        ...
        <section className="py-8 md:py-14 lg:py-28 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto space-y-12">
            <div>
              ...
              <p className="mb-4">
                Kittens zijn tot en met een leeftijd van{" "}
                <strong>16 weken</strong> welkom voor een{" "}
                <strong>gratis kennismaking</strong> met de trimsalon. Dit is
                heel goed voor de socialisatieperiode.
              </p>
              ...
              <p className="mb-2">
                De eerste keer dat u uw kat vervilt bij ons aanbiedt zal deze
                van het vilt worden verlost tegen het{" "}
              ...
              <p className="mb-2">
                ...
                <strong>apart in rekening gebracht</strong>. De exacte hoogte
                van de toeslag is afhankelijk van de ernst van de vervilting.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mb-4">
                Puppies tot en met <strong>16 weken</strong> zijn welkom voor
                een <strong>kennismaking</strong> met de trimsalon. De prijs
                voor een puppybehandeling is <strong>€ 45,-</strong>.
              </p>
              ...
              <p className="mb-4">
                We werken met <strong>vanaf-prijzen</strong> om u zoveel
                mogelijk duidelijkheid te geven. Onderstaand overzicht is niet
