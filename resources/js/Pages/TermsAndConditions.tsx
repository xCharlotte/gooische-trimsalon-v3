          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            <div>
              ...
              <p>
                ...
                offertes en overeenkomsten van Gooische Trimsalon. Afwijkingen
                zijn alleen geldig als deze schriftelijk zijn overeengekomen.
                Bij tegenstrijdige voorwaarden prevaleren deze voorwaarden boven
                die van de klant.
              </p>
            </div>

            <div>
              <h2 className="font-semibold text-lg">2. Offertes en prijzen</h2>
              <p>
                ...
                apart in rekening gebracht. Als kosten stijgen binnen 4 maanden
                na het sluiten van de overeenkomst, mag de klant kosteloos
                annuleren.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Een overeenkomst komt tot stand zodra een afspraak mondeling of
                schriftelijk is bevestigd. Vanaf dat moment is deze bindend.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                weigeren als er twijfels zijn over de betalingscapaciteit van de
                klant.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                of gevolgschade. Bij schade aan het dier is de aansprakelijkheid
                beperkt tot de kosten van noodzakelijke veterinaire zorg, met
                een maximum gelijk aan de aanschafwaarde van het dier. Schade
                dient aantoonbaar en direct gevolg te zijn van nalatig handelen.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                kosteloos hersteld. Dit geldt alleen als de klacht binnen 24 uur
                na de behandeling is gemeld.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                via pin te worden voldaan, tenzij anders is overeengekomen. Niet
                of te laat geannuleerde afspraken worden als volgt in rekening
                gebracht:
              </p>
            ...
            <div>
              ...
              <p>
                ...
                persoonsgegevens van klanten. Hoe wij met deze gegevens omgaan,
                staat beschreven in onze{" "}
                <a
